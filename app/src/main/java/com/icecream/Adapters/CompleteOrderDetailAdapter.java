...
public class CompleteOrderDetailAdapter extends RecyclerView.Adapter<CompleteOrderDetailAdapter.MyViewHolder> {

    private List<OrderDetail> arrOrders;
    private Activity activityContext;

    public CompleteOrderDetailAdapter(Activity activity, List<OrderDetail> arrResouceslist) {
